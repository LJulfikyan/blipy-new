...
class _CustomCardState extends State<CustomCard> {
    ...
    return FutureBuilder(
      builder: (context, httpResponse) {
        if (widget.feedItems!.isEmpty) {
          return Center(
            child: Image.asset('./assets/images/eclipse_74.png'),
          );
        } else if (widget.feedItems == null) {
          return Container(
        ...
        return LazyLoadScrollView(
          ...
          child: RefreshIndicator(
            ...
            onRefresh: () async {
              page = 0;
              await postsPageState.getMyPosts(
                  page * 20, 20, postsPageState.isFavourite);
            },
                                  ...
                                  ClipRRect(
                                    ...
                                    child: Image.network(
                                      ...
                                      loadingBuilder: (BuildContext context,
                                        ...
                                        return Center(
                                          child: Lottie.asset(
                                              './assets/animations/load_data.json'),
                                        );
                                      },
                                    ),
                                  ),
  ...
  void scrollListener() async {
    postsPageState.page++;
    FeedData? data = await postsPageState.loadMore(
        postsPageState.page * 20, 20, postsPageState.isFavourite);
    setState(() {
